    ...
    <div className="teacher-batches animate-fade-in">
      ...
      <div className="card reg-student-card" style={{ marginBottom: "2.5rem" }}>
        ...
        >
          ...
          <div className="form-group">
            <label htmlFor="reg-last-name">Last Name / Surname</label>
            <input
              id="reg-last-name"
              type="text"
          ...
          <div className="form-group">
            <label htmlFor="reg-username">Generated Username</label>
            <input
              id="reg-username"
              type="text"
          ...
          <div className="form-group">
            <label htmlFor="reg-batch">Select Batch Timings</label>
            <select
              id="reg-batch"
              value={regBatchId}
        ...
        {batches.map((batch) => (
          <div key={batch._id} className="card batch-card">
                  ...
                  {batch.students.map((student) => (
                    <li key={student} className="roster-item">
                      ...
                      <button
                        ...
                        aria-label={`Remove ${student} from ${batch.name}`}
                      >
                        ✕
                      </button>
                    </li>
            ...
            >
              <input
                type="text"
                aria-label={`Add student username to ${batch.name}`}
