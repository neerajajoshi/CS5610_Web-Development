      ...
      <div className="card register-setup-card">
        <div className="setup-controls">
          <div className="form-group">
            <label htmlFor="attendance-batch">Select Time Slot / Batch</label>
            <select
              id="attendance-batch"
            ...
            <form onSubmit={handleSave}>
              <div className="attendance-table-container">
                <table className="attendance-table">
                  <thead>
                    <tr>
                      <th scope="col">Student Roster</th>
                        ...
                        <td style={{ textAlign: "center" }}>
                          <label className="radio-label">
                            <input
                              ...
                              aria-label={`Mark ${student.username} present`}
                            />
                        ...
                        <td style={{ textAlign: "center" }}>
                          <label className="radio-label">
                            <input
                              ...
                              aria-label={`Mark ${student.username} absent`}
                            />
